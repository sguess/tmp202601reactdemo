...
function PutExample() {
  ...
  const loadDefaultData = async () => {
    try {
      ...
      // 获取默认数据
      const fetchResponse = await fetch(`https://jsonplaceholder.typicode.com/posts/${formData.id}`)
  ...
  const updatePost = async (e) => {
    ...
    try {
      ...
      // 使用fetch API发送PUT请求到JSONPlaceholder API
  ...
  return (
    <div className="api-example-page">
      <h1>PUT请求示例</h1>
      <p>本示例演示如何使用浏览器内置的fetch API发送PUT请求更新数据。</p>
      ...
      <div className="example-container">
        ...
        <ul>
          ...
          <li>点击加载按钮获取当前数据</li>
          <li>修改表单数据</li>
          <li>点击更新按钮发送PUT请求到JSONPlaceholder API</li>
          <li>显示服务器返回的响应数据</li>
          <li>展示请求的响应时间</li>
          <li>处理可能出现的错误</li>
        </ul>
        ...
        {/* 表单 */}
        <form onSubmit={updatePost} className="api-form">
          <div className="form-group">
            <label htmlFor="id">帖子ID:</label>
            <input
              type="number"
              id="id"
              name="id"
